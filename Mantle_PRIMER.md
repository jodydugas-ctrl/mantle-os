...
Path B (assimilate EXISTING code, non-destructive; the basis of `anchor` and the `graft` egg):
  docs/grimoire/The Grimoire AppAI Chapter 4.4.md  <- CANONICAL doctrine (NECROMANCY operational detail)
...
2. Follow the canonical doctrine in **`docs/grimoire/The Grimoire AppAI Chapter 4.4.md`**
