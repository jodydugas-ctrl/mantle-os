...
- **Assimilating existing code (Path B — [`docs/grimoire/The Grimoire AppAI Chapter 4.1.md`](grimoire/The%20Grimoire%20AppAI%20Chapter%204.1.md), NECROMANCY operational detail):** *dissect first.* The Phase 0
