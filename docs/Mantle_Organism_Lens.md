...
- **Assimilating existing code (Path B — [`../docs/grimoire/GRIMOIRE_APPAI_DOMAIN_v1_0.md`](grimoire/GRIMOIRE_APPAI_DOMAIN_v1_0.md), NECROMANCY operational detail):** *dissect first.* The Phase 0
