#!/usr/bin/env python3
"""
refs.py  --  The unified reference resolver (Mantle v2.1)
...
Examples:
    ...
    <calendar.182x3>      Prime calendar layer, cell (182,3)

A reference that resolves to nothing is a DANGLING reference: it is logged to the immune band,
