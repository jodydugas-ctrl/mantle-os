...
def demo(argv):
    ...
    print("=" * 74)
    print("ARGONAUT OS — PHASE 1: A BODY LIVES (no LLM anywhere in this demo)")
    print("=" * 74)
...
def mind_demo(argv):
    ...
    print("=" * 74)
    print("ARGONAUT OS — PHASE 2: FUSING A BOUNDED MIND (offline stub; no key/network)")
    print("=" * 74)
...
def assimilate(argv):
    ...
    print("=" * 74)
    print("ARGONAUT OS — ASSIMILATOR (Path B)  ·  READ-ONLY dissection of: %s" % root)
    print("=" * 74)
    result = dry_run(root)
    amap = result["map"]
