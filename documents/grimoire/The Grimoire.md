...
|---|---|---|---|
| **Intellige** | grok, understand, inspect, read first | `grok + telos + umwelt + aporias` (READ-ONLY COMPREHENSION) | read, model, and explain before acting; read-only unless a later cast is selected; confers no authority |
...
Seven spells carry gates and procedures beyond the envelope.
