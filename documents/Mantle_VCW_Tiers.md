...
**Mantle OS** · Non-normative concept note.
...
2. **`body.py`** — the organism's Body subclass, importing from `src/mantle/core/body.py`.
...
- A JavaScript-only VCW (Trap 3 in `documents/Mantle_LLM_Pitfalls.md`)
